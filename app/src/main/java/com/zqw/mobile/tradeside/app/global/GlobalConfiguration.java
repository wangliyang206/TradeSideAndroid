...
import com.zqw.mobile.tradeside.app.config.ActivityLifecycleCallbacksImpl;
import com.zqw.mobile.tradeside.app.config.AppLifecyclesImpl;
import com.zqw.mobile.tradeside.app.config.FragmentLifecycleCallbacksImpl;
import com.zqw.mobile.tradeside.app.config.GlobalHttpHandlerImpl;
import com.zqw.mobile.tradeside.app.config.ResponseErrorListenerImpl;
import com.zqw.mobile.tradeside.app.config.SSLSocketClient;
